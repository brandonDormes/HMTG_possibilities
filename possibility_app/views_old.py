...
#game_dat = game_dat.loc[game_dat.trustee == 93]  # 97, 54, 62
ntrials = 45
    ...
    if session['practice']:
        ...
        if request.method == 'GET':
            ...
            return render_template('decision.html', trial_num=session['trial'], # trial was incremented after prediction
                                   ...
                                   interval=interval,  #" ".join([str(e) for e in probes]), #"oh hey",#[str(i) for i in probes],
                                   last_trl=ntrials,
                                   ntrials=ntrials)
